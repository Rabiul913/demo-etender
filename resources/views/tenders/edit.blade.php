        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <div class="pull-right">
                <a class="btn btn-primary btn-sm float-right" href="{{ route('tenders.index') }}"> Back</a>
            </div>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                          ...
                          <form action="{{ route('tenders.update',$tender->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            @csrf
                              <div class="row">
                                  ...
                                  <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong for='tender_type_id'>Type:</strong><br>
                                       @foreach ($tender_types as $type)
                                         <input type="radio" @if($tender->tender_type_id == $type->id) checked="true" @endif value="{{ $type->id }}" name="tender_type_id">{{ $type->name }}
                                       @endforeach
                                    </div>
                                </div>
                                  ...
                                  <div class="col-xs-12 col-lg-6 col-md-12">
                                      <div class="form-group">
                                          ...
                                          <input class="form-control" type="date" id="create_date" value="{{ $tender->create_date > 0 ? date("Y-m-d", strtotime($tender->create_date)) : '' }}" name="create_date">
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-lg-6 col-md-12">
                                      <div class="form-group">
                                          ...
                                          <input class="form-control" type="date" id="publish_date" value="{{ $tender->publish_date > 0 ? date("Y-m-d", strtotime($tender->publish_date)) : '' }}" name="publish_date">
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-lg-6 col-md-12">
                                      <div class="form-group">
                                          ...
                                          <input class="form-control" type="date" id="deadline"  value="{{ $tender->deadline > 0 ? date("Y-m-d", strtotime($tender->deadline)) : '' }}" name="deadline">
                                      </div>
                                    </div>
